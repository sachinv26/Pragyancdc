            ...
            child: Column(
              children: [
                TabBar(
                  ...
                  tabs: const [
                    Tab(child: ContainerTabLabel('Therapy Lists')),
                    Tab(child: ContainerTabLabel('Add Therapy')),
                  ],
                ...
                Expanded(
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      const Center(
                        child: Text('Add Therapy Content'),
                      ),
                    ],
                  ),
                ),
...
class ContainerTabLabel extends StatelessWidget {
  ...
  const ContainerTabLabel(this.label, {super.key});
