                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              onChanged: (value) {
                                setState(() {
                                  ...
                                  newDatesSlots = calculateNewDatesAndSlots(
                                      value!,
                                      widget
                                          .selecteddateslots); // Recalculate new dates and slots
                                });
                              },
                              items: [4, 8, 12]
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children:
                              widget.selecteddateslots.entries.map((entry) {
                                          ...
                                          showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                ...
                                                content: const Text('Do you want to delete the slot?'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () {
