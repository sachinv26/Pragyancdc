          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: isPastTime
                  ? Colors.grey
                  : isBookedbyParent
                  ? const Color(0XFFFF7D29) // Change color to orange for booked by parent
                  : isBooked
                  ? Colors.grey // Change color to grey for already booked
                  : isSelected
                  ? const Color(0XFF06D001)
                  : isWeekOffDay || isHoliday
                  ? const Color(0XFF373A40).withOpacity(0.7) // Grey for unavailable slots due to week off or holiday
                  : isWithinShifts
                  ? Colors.grey
                  : Colors.grey,),
              borderRadius: BorderRadius.circular(5),
